from agents.amma_circle_agent import post_community_message
...
def orchestrator_agent(user_input: str, language: str = "english", history: str = "", mother_data: dict = {}):
    ...
    if intent == "SYMPTOM":
        ...
        return post_community_message(
            session_id="temp",  # Will be overridden by route
            message=user_input,
            trimester=trimester,
            taluk=taluk,
            language=language
        ).get("ai_response", "Message posted to Amma Circle!")
