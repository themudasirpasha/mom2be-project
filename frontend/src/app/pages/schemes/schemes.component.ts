...
export class SchemesComponent implements OnInit {
  ...
  processingAgents: ProcessingAgent[] = [
    { name: 'analyzer', label: 'Analyzing eligibility…', completed: false, active: false },
    { name: 'schemes', label: 'Finding schemes…', completed: false, active: false },
